...
```
/workspace/
├── build.js                 # 核心构建脚本（14 题数据 + 模板 + KaTeX 渲染 + 生成 index/题目页）
...
| id | 分类 | 题型 | 难度 | 标题 |
|------|--------|--------------|------|------|
| p9   | 二次根式 | 计算填空 | ★★★☆ | 最简二次根式与同类二次根式 |
| p4   | 二次根式 | 选择填空 | ★★☆☆ | 同类二次根式的判定 |
| p6   | 二次根式 | 阅读理解+计算 | ★★★☆ | 整体代入法 |
| p5   | 二次根式 | 计算填空 | ★★☆☆ | 整体代换与链式平方 |
| p19  | 二次根式 | 二次根式 | ★★★☆ | 二次根式配凑 |
| p1   | 最值问题 | 应用题 | ★★★☆ | 篱笆围菜园 |
| p2   | 最值问题 | 综合应用 | ★★★★ | 四边形面积最小值 |
| p12  | 几何综合 | 几何综合 | ★★★★ | 矩形 OABC 角度三等分 |
| p14  | 几何综合 | 几何综合 | ★★★★ | 直线围成三角形 + 正方形 + 平行四边形 |
| p16  | 几何综合 | 几何综合 | ★★★★ | 菱形中的动点 |
| p3   | 几何综合 | 几何综合 | ★★★☆ | 网格中的角度求和 |
| p15  | 函数与统计 | 选择填空 | ★★☆☆ | 函数的判断 |
| p17  | 函数与统计 | 函数与统计 | ★★☆☆ | 弹簧长度与质量的函数关系 |
| p18  | 函数与统计 | 函数与统计 | ★★★☆ | 甲乙两组成绩分析（四分位数 + 箱线图 + 方差） |
