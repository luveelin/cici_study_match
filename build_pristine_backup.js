...
const katexCss = fs.readFileSync('/workspace/node_modules/katex/dist/katex.min.css', 'utf-8');
...
<div style="text-align:center;margin:10px 0;">
  <img src="images/p12_fig1.png" alt="图1：E在B右侧" style="max-width:100%;border-radius:8px;border:1px solid #e2e8f0;">
...
<div style="text-align:center;margin:10px 0;">
  <img src="images/p12_fig2.png" alt="图2：E在A左侧" style="max-width:100%;border-radius:8px;border:1px solid #e2e8f0;">
...
`
  },
  {
    id: "p14",
    file: "p14.html",
    title: "第14题 直线围成三角形 + 正方形 + 平行四边形（综合）",
    type: "几何综合",
...
`
  },
  {
    id: "p18",
    file: "p18.html",
    title: "第18题 甲乙两组成绩分析（四分位数 + 箱线图 + 方差）",
    type: "函数与统计",
...
`
  },
  {
    id: "p19",
    file: "p19.html",
    title: "化简题① 二次根式配凑（2023+1/2025）×4050",
    type: "二次根式",
...
function stopDragResize() {
  ...
  fs.writeFileSync(`/workspace/problems/${p.file}`, html);
...
fs.writeFileSync('/workspace/index.html', indexHtml);
